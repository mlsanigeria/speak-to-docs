...
- **speech_to_docs/main.py**: The main.py script serves as the core interface for the Speech-Enabled RAG Solution, facilitating voice interactions with documents through Azure Cognitive Services for speech transcription and synthesis, while managing user interactions and session states.
